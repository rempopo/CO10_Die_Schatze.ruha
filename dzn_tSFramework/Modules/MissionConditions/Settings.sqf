...
MissionCondition1 = [ 
 "WIN", { [ Brigitta, "east", "", "< 3"] call dzn_fnc_ccUnits] && {call fnc_CheckPlayersReturned} }, 
 "All objectives done"
];
...
MissionCondition3 = [ 
 "WIN2", { [ Angela, "east", "", "< 3"] call dzn_fnc_ccUnits] && {call fnc_CheckPlayersReturned} }, 
 "All objectives done"
];

MissionCondition4 = [ 
 "WIN3", { [ Angela, "east", "", "< 3"] call dzn_fnc_ccUnits] && [ Brigitta, "east", "", "< 3"] call dzn_fnc_ccUnits] && {call fnc_CheckPlayersReturned} }, 
 "All objectives done"
];